[myfirsttssproject-2b5c] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myfirsttssproject-2b5c] container is NOT running**.

.. tip::
   You must have your [myfirsttssproject-2b5c] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/vanesalcb06/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=35359  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='vanesalcb06'  \-\-env DOCKERUSERNAME='vanesalcb'  \-\-env MQTTUSERNAME='vanesalcb'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   vanesalcb/myfirsttssproject-2b5c-amd64 (https://hub.docker.com/r/vanesalcb/myfirsttssproject-2b5c-amd64)
...
.. important::
   docker run -d -p 51673:51673 -p 43043:43043 -p 51857:51857 \-\-env TSS=0 \-\-env SOLUTIONNAME=myfirsttssproject-2b5c \-\-env SOLUTIONDAG=solution_preprocessing_dag-myfirsttssproject-2b5c \-\-env GITUSERNAME=vanesalcb06  \-\-env GITREPOURL=https://github.com/vanesalcb06/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=51673  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=43043  \-\-env SOLUTIONVIPERVIZPORT=51857 \-\-env DOCKERUSERNAME='vanesalcb'  \-\-env EXTERNALPORT=35359 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='vanesalcb' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  vanesalcb/myfirsttssproject-2b5c-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=51857
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=51673
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - vanesalcb/myfirsttssproject-2b5c-amd64
...
It can be accessed by entering: http://localhost:43043
...
.. important::
   http://localhost:51857/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:51857/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:51857/<html file>
...
[myfirsttssproject-2b5c] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/vanesalcb06/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myfirsttssproject-2b5c
...
.. important::
   https://myfirsttssproject-2b5c.readthedocs.io
...
.. important::
   solution_preprocessing_dag-myfirsttssproject-2b5c
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=51673, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44573, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33411, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=45617, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33759, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40345, HPDEHOST=127.0.1.1, HPDEPORT=35659, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42101

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-172-myfirsttssproject-2b5c,solution_preprocessing_dag-myfirsttssproject-2b5c, python-preprocess-8523-myfirsttssproject-2b5c,solution_preprocessing_dag-myfirsttssproject-2b5c, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
